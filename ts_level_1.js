...
function drawLevel1() {
    ...
    let scaleAmount = 3; // Scale amount for map and camera
    
    // Directly render each tile without adjusting for center
    tiles.forEach(tile => {
        image(tile.img,
              tile.dx * scaleAmount, // Use original position without offset
              tile.dy * scaleAmount, // Use original position without offset
